    ...
    <div class="hero-head">
      <nav class="navbar is-transparent">
        ...
        <div class="navbar-brand">
          ...
          href="https://github.com/alex-src/vault" target="_blank">
        ...
        <div class="navbar-menu">
          ...
          <div class="navbar-end">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
              ...
              <div class="navbar-dropdown is-boxed">
                <a class="navbar-item" target="_blank" href="https://github.com/alex-src/vault/wiki/Configuration#run-time-configurations">
                  Configuration
                </a>
                <a class="navbar-item" target="_blank" href="https://github.com/alex-src/vault/wiki/Features">
                  Features
                </a>
                <a class="navbar-item" target="_blank" href="https://github.com/alex-src/vault">
                  Source
                </a>
            ...
            <div class="navbar-item">
              <div class="field is-grouped">
                <p class="control">
                  ...
                  href="https://github.com/alex-src/vault"
                  target="_blank">
                    <span class="icon">
                      <i class="fa fa-github"></i>
                    </span>
