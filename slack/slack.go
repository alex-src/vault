...
var icon_url = "https://github.com/alex-src/vault/raw/master/frontend/client/assets/logo_small.png"
		...
		map[string]interface{}{
			...
			"attachments": []interface{}{
				map[string]interface{}{
					...
					"footer":      "<https://github.com/alex-src/vault|Alex2006hw Vault UI>",
